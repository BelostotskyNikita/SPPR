...
namespace WEB_253503_Belostotsky.API.Services.ProductService
{
  ...
  /// <returns></returns>
  public Task<ResponseData<ListModel<ClothingItem>>> GetProductListAsync(
...
int pageSize = 3);
        ...
        /// <returns></returns>
        public Task UpdateProductAsync(int id, ClothingItem product);
        /// <summary>
        /// Удаление объекта
        /// </summary>
        ...
        public Task<ResponseData<ClothingItem>> CreateProductAsync(ClothingItem product);
        /// <summary>
